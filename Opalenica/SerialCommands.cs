...
internal class SerialCommands
{
    private readonly static Dictionary<string, byte[]> _commandsDec = new Dictionary<string, byte[]>()
    {
        ...
        { "sem q sz"  , new byte[] { 0x24, 0x33, 0x33, 0x32, 0x30, 0x31, 0x33, 0x25 } },
        { "sem q osz" , new byte[] { 0x24, 0x33, 0x33, 0x30, 0x30, 0x33, 0x33, 0x25 } },
        { "sem r sz"  , new byte[] { 0x24, 0x33, 0x35, 0x32, 0x30, 0x31, 0x35, 0x25 } },
        { "sem r osz" , new byte[] { 0x24, 0x33, 0x35, 0x30, 0x30, 0x33, 0x35, 0x25 } },
    };
