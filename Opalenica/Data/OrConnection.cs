...
public class OrConnection : Connection
{
    public Data Input2 { get; internal set; }

    public static OrConnection GetConnection(Data input1, Data input2, Data output)
    {
        ...
        if (Connections.FirstOrDefault(e => e?.Name == name, null) is not null and OrConnection oconn) return oconn;
        var conn = new OrConnection()
        {
            Input = input1,
            Input2 = input2,
            Output = output,
    ...
    public static OrConnection GetConnection(string input1, string input2, string output)
    {
        Data? i1, i2, o;
